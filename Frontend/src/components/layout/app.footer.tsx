        ...
        <Row>
          <Col md={3}>
            <div>
              ...
              <p>Đại lý thẻ điện thoại, thẻ game trực tuyến, nạp tiền điện thoại. Thanh toán tự động, nhanh chóng và uy tín.</p>
            </div>
          </Col>
          <Col md={3} xs={6}>
            <div>
              ...
              <ListGroup variant="flush">
                <ListGroup.Item className="bg-light border-0 p-0">
                  <a href="#" className="text-dark">
                    <FontAwesomeIcon icon={faPhoneAlt} className="me-2" /> 0984 459 954
                  </a>
                </ListGroup.Item>
                <ListGroup.Item className="bg-light border-0 p-0">
                  <a href="merchant/list.html" className="text-dark">
                    <FontAwesomeIcon icon={faEnvelope} className="me-2" /> diepit9x@gmail.com
                  </a>
                </ListGroup.Item>
              </ListGroup>
            </div>

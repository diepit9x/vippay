import {
    ...
    IAuthActionPrams,
    TAuthAction,
} from '@/models/request/auth/auth.action';
import { IAuthLogin } from '@/models/request/auth/auth.login';
import { IAuthResetPassword } from '@/models/request/auth/auth.resetPassword';
import { Button, Form, message, Modal } from 'antd';
import { useCallback, useEffect, useRef, useState } from 'react';
import ReCAPTCHA from 'react-google-recaptcha';
import Login from '@/components/user/auth/form/Login';
import ResetPassword from '@/components/user/auth/form/ResetPassword';
import Register from '@/components/user/auth/form/Register';
